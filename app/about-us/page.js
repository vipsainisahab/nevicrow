								...
								<div className="col-lg-12">
									<div className="video-h4-widget relative overflow-hidden mb--14em">
										<div className="video-wrap">
											<a onClick={() => setOpen(true)} className="video-box flex-five z-index3 relative widget-videos">
							...
							<div className="row">
								<div className="col-sm-6 col-lg-3">
									<div className="tf-counter center tf-countto">
										...
										<div className="number-counter number" data-to={5489} data-speed={2000} data-waypoint-active="yes"><CounterNumber count={5489} /></div>
										<span className="line" />
								...
								<div className="col-sm-6 col-lg-3">
									<div className="tf-counter center tf-countto">
										...
										<div className="number-counter percen" data-to="99.9" data-speed={2000} data-waypoint-active="yes"><CounterNumber count={99} /></div>
										<span className="line" />
								...
								<div className="col-sm-6 col-lg-3">
									<div className="tf-counter center tf-countto">
										...
										<div className="number-counter plus" data-to={190} data-speed={2000} data-waypoint-active="yes"><CounterNumber count={190} /></div>
										<span className="line" />
							...
							<div className="row relative z-index3">
								<div className="col-lg-12">
									<div className="instagram-post-grid">
										<Link href="#" className="tf-instagram relative overflow-hidden">
