...
export default function TopWeek() {
	return (
		<>
			...
			<section className="bg-1 widget-top-week">
						...
						<div className="col-lg-12">
							<div className="mb-60">
								<span className="sub-title-heading text-main font-yes fs-28-46 wow fadeInUp animated">Explore
									the world</span>
								<h2 className="title-heading wow fadeInUp animated">Our top this week</h2>
							</div>
						</div>
					</div>
					<div className="row">
						<div className="col-lg-12 relative on-week-swipper-wrap">
							<Swiper {...swiperOptions} className="swiper on-week-swipper overflow-hidden relative">
