...
export default function SelectForm1() {
                      ...
                      <fieldset className="group-select relative input-npd ">
                        <div className="search-bar-group relative">
                          ...
                          <select className="nice-select" tabIndex={0}>
                            ...
                            <option data-value="language1" className="option">
                              Japan
                            </option>
                            <option data-value="language2" className="option">
                              Vietnames
                            </option>
                            <option data-value="language3" className="option">
                              Korea
                            </option>
                          </select>
                        </div>
                      ...
                      <fieldset className="group-select relative input-npd">
                        <div className="search-bar-group relative">
                          ...
                          <select className="nice-select" tabIndex={0}>
                            ...
                            <option data-value="duration1" className="option">
                              10-15 day
                            </option>
                            <option data-value="duration2" className="option">
                              15-30 day
                            </option>
                            <option data-value="duration3" className="option">
                              20-30 day
                            </option>
                          </select>
                        </div>
